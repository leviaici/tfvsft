...
pnet = PNet()
pnet.load_state_dict(torch.load("trained_pnet_404.pth")) # Load the trained PNet model (best version so far); if you want to use the latest version, change the parameter to "trained_pnet.pth"
